    ...
    def mykeyborad_click(self, z): 
        try:
            ...
            if z=='[size=72]←[/size]':
                ...
                'b5':('[size=72]→[/size]','#EEEEEE'), 'b6':('[size=76]⌫[/size]','#EEEEEE'), 'b7':('∫⬚dx','#DEDEDE'), 'b8':('[sub]⬚[/sub]∫[sup]⬚[/sup] ⬚','#DEDEDE'),'b9':('∫∫⬚','#DEDEDE'),
                ...
                'b5':('[size=72]→[/size]','#EEEEEE'), 'b6':('[size=76]⌫[/size]','#EEEEEE'), 'b7':('[color=#173EFF]∫⬚dx[/color]','#DEDEDE'), 'b8':('[color=#173EFF][u] d⬚[/u] \n dx[/color]','#DEDEDE'),'b9':('lim\n[sup] x → ⬚[/sup]','#DEDEDE'),
...
class HelpScreen(Screen):
    try:
        def help_gif_pre(self, topic):
            ...
            if topic == 1 or topic == 3 or topic == 6:
        ...
        def help_topics(self, topic): 
            ...
            ctnt=BoxLayout(orientation='vertical',spacing='1dp') 
            self.img_help=Image(source='', allow_stretch=True, keep_ratio=False, anim_delay=0.7) #https://ezgif.com/maker  -->en iyisi
            ...
            if topic == 1:
                self.img_help.source='algebra.gif'
                ttopic = 'Algebra'
            elif topic == 2:
...
[color=#777777]Update tag: [/color][color=#D26200]#Pearl[/color]
"""
